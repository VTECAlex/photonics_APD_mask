...
def PCM_Dark_Current(extra_length, Quadrant, i,j, show_name, show_frame):
    ...
    with nd.Cell(name = 'Device Cell V2') as Dark_Current_PCM_V1:
        ...
        extra_length_radius = 30 + P_type_ring_distance +7.5
        ...
        APD_x_position = [-56, -52.5-22.5, -117.2-7.8, -181.2+6.2, -245.32+20.32]
        APD_distance = 600
        ...
        while k<len(APD_radii):
            with nd.Cell(name = "Devices") as Devices:
                ...
                APD_name = nd.text(text = "r{}".format(int(APD_radii[k]-extra_length_radius)), height= 200, layer = 'Metal Rings').put(APD_radii[k]-P_type_ring_width- (P_type_ring_width-P_type_ring_SiO_opening_width)/2+P_type_ring_distance+200-110-150+220,-127-50+100+107+70)#put(APD_radii[k]-P_type_ring_width- (P_type_ring_width-P_type_ring_SiO_opening_width)/2+P_type_ring_distance+200-110,100+107)
            ...
            if True:
                ...
                top_right_hole  = metal_corners.Metal_corners_hole('Open Corners').put(1000+65-200+25,+4230-150+200,-90)


                bot_right  = metal_corners.Metal_corners('Metal Rings').put(-1000+2015+25,-1000+430-50,90)
                bot_right_hole  = metal_corners.Metal_corners_hole('Open Corners').put(-1000+2015-200+50+200,-1000+430-50+200-25,180)
...
nd.export_gds(filename=r'Dark Current')