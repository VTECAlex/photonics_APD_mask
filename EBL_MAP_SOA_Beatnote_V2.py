...
for x_y_coords in List_Coordinates_Coarse_Fine_AMs:
    ...
    nd.put_stub(pinlayer="Pin Layer")


def array_devices(num_cols,
                  num_rows,
        ...
        for j in range(1,number_of_devices_columns+1):
            ...
            if current_radius< wafer_radius-additional_exclusion:
                if (j,i) not in excluded_devices:
                    ...
                    k=k+1
                    nd.put_stub(pinshow=show_pin_centers, pinlayer="Pin Layer")
...
print("complete")
nd.export_gds(filename = "EBL_MAP_SOA_Beatnote_V2.gds")
