        ...
        if (iii%2==0 and jjj%2==0) or (iii%2!=0 and jjj%2!=0):
            with nd.Cell(name = "HorVernTop44566543455") as HorVernTop:
                ...
                for i in range(1,number_of_rods//2+1):
                    ...
                    #nd.text("-{}".format(i), height=(letter_height)).put(-HorVernCombTopRodDist*i+3*x_correction_horiz_letters,0, 45)
                    SeedComb2top.put(HorVernCombTopRodDist*i,0,-90)
                    #nd.text("{}".format(i), height=(letter_height)).put(HorVernCombTopRodDist*i+x_correction_horiz_letters,0, 45)
            ...
            with nd.Cell(name = "HorVernBot3345566") as HorVernBot:
                ...
                nd.text("0", height=(letter_height), layer = 2).put(x_correction_horiz_letters -2.5,-3.2*rod_length+dist_combs-9- 25)
                for i in range(1,number_of_rods//2+1):
            ...
            nd.text("x", height=(100), layer = 2).put(-305,-3*rod_length-dist_combs-distnace_of_top_bot_combs_horiz+25)
            nd.text("{0:2}".format(0.25), height=(200), layer = 2).put(-180-40,-3*rod_length-dist_combs-distnace_of_top_bot_combs_horiz+364 - 120)
                
    VernierHorizontal.put(2000+430,-2300-330)
