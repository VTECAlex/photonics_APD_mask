...
gVernierHorizontalGeert.put(-1000,-1000)
...
with nd.Cell(name = "Vernier") as gVernierVerticalGeert:
    ...
    with nd.Cell(name = "VerVernBot") as gVerVernRightGeert:
        ...
        for i in range(1,gnumber_of_rods//2+1):
            SeedComb2BotGeert.put(0,-gVerVernCombBotRodDist*i+gVerVernCombTopRodDist/2)
...
gVernierVerticalGeert.put(0,10000)
