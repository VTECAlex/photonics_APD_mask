        ...
        with nd.Cell (name = 'Right Side Devices') as Right_side_Devices:
            ...
            while k<len(APD_radii):
                ...
                with nd.Cell(name = "Devices") as Devices:
                    Square_MESA  = nd.strt(length= 2*APD_radii[k], width= 2*APD_radii[k], layer = "MESA etch").put(-2*APD_radii[k]/2,0)
...
nd.export_gds(filename=r'Device Tile V3 For N Substrate Square MESA')