...
from SVG_BeatNoteDesign_Active_Layer_SOA import SVG_Lasers_Group
import csv
...
def SVG_EBL_PatternMAp_V3_Active_SOAs(am_layer,
...
SVG_EBL_PatternMAp_V3_Active_SOAs("Pattern",
