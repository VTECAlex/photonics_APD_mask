...
def Tile_PCMs_all(extra_length, Quadrant, i,j):
    ...
    with nd.Cell(name = 'One tile') as Single_Tile:
        ...
        width_wvg = 1.5
        text_position_x = -extra_length/2-1345+200-120-500+500
        text_position_y =1328.625
        text_position_y_layer_ID = -745+300+300-700-1500
        text_rotation = -90
        text_height = 200
        ...
        # with nd.Cell(name = "EVG alignment mark") as Top_EVG_alignment_mark:
        #
        #     distititi = 100
        #     circle_reticle_layer = 333
        #     small_circle = nd.Polygon(layer = circle_reticle_layer,points= geom.circle(30, N=700))
        #     small_circle.put(0,0)
        #     large_circle = nd.Polygon(layer = circle_reticle_layer,points= geom.circle(50, N=700))
        #     large_circle.put(distititi,0)
        #     small_circle.put(distititi,distititi)
        #
        #     large_circle.put(0,distititi)
        #
        # with nd.Cell(name = "EVG alignment mark") as Bot_EVG_alignment_mark:
        #
        #     distititi = 100
        #     circle_reticle_layer = 444
        #     small_circle = nd.Polygon(layer = circle_reticle_layer,points= geom.circle(30, N=700))
        #     small_circle.put(0,0)
        #     large_circle = nd.Polygon(layer = circle_reticle_layer,points= geom.circle(50, N=700))
        #     large_circle.put(distititi,0)
        ...
        if Quadrant == 1:
            ...
            nd.text("R{}C{}Q{}".format((j+1),(i+1),(1)), height= text_height, layer='Au plating ').put(text_position_x, text_position_y_layer_ID,text_rotation)

        elif Quadrant == 2:
            #nd.text("l{}um".format((1+extra_length/1000)), height= text_height).put(text_position_x, text_position_y,text_rotation)
            nd.text("R{}C{}Q{}".format((j+1),(i+1),(2)), height= text_height, layer='Au plating ').put(text_position_x, text_position_y_layer_ID,text_rotation)

        elif Quadrant ==3:
            #nd.text("l{}um".format((1+extra_length/1000)), height= text_height).put(text_position_x, text_position_y,text_rotation)
            nd.text("R{}C{}Q{}".format((j+1),(i+1),(3)), height= text_height, layer='Au plating ').put(text_position_x, text_position_y_layer_ID,text_rotation)

        else:
            #nd.text("l{}um".format((1+extra_length/1000)), height= text_height).put(text_position_x, text_position_y,text_rotation)
            nd.text("R{}C{}Q{}".format((j+1),(i+1),(4)), height= text_height, layer='Au plating ').put(text_position_x, text_position_y_layer_ID,text_rotation)

    
    
        
        nd.text("VTEC", height =text_height, layer= 'Au plating ' ).put(1000+text_position_x ,text_position_y_layer_ID,0)
        ...
        def matrix_of_bars(layer_bars):
            with nd.Cell(name = "Matrix of bars") as matrix_of_bars:
                    ...
                    with nd.Cell(name = "test cell") as test_cell:
                        ...
                        with nd.Cell(name = "Clumn of bars") as Column_of_bars:
                            ...
                            for i in range(nobviw):
                                yy = (200+width_of_metal_pad)*i-layerN
                ...
                if layer == 'Metal Rings':
                    nd.text("Ti/Pt/Au", height= text_height, layer = layer).put(270,+850-33,0)
                elif layer=='N Metal':
                    nd.text("Ni/Ge/Au",height= text_height, layer=layer).put(270, +850-33, 0)
                else:
                    nd.text("Au plating", height= text_height, layer = layer).put(190,+850-33)
            return matrix_of_bars
                
        Bars1 = matrix_of_bars('Metal Rings').put(-1750,-1812,0)
        Bars2 = matrix_of_bars('N Metal').put(-150,-1812,0)
        Bars3 = matrix_of_bars('Au plating ').put(1450,-1812,0)
        ...
        ###########METAL CORNERS#######
        ######Metal Corners
        top_left = metal_corners.Metal_corners('Metal Rings').put(-1000 + 115-865, 4279.86 + 0.14-1830, -90)
        top_left_hole = metal_corners.Metal_corners('Open Corners').put(-1000 + 115 + 200 - 50-865, 4279.86 + 0.14 - 200-1830,
                                                                        90)

        top_right = metal_corners.Metal_corners('Metal Rings').put(1000 + 65+3835, +4230-1830, 180)
        top_right_hole = metal_corners.Metal_corners('Open Corners').put(1000 + 65 - 200+3835, +4230 - 150-1830, 0)

        bot_right = metal_corners.Metal_corners('Metal Rings').put(-1000 + 2015+3835, -1000 + 430 - 50-1830, 90)
        bot_right_hole = metal_corners.Metal_corners('Open Corners').put(-1000 + 2015 - 200 + 50+3835,
                                                                         -1000 + 430 - 50 + 200-1830, -90)

        bot_left = metal_corners.Metal_corners('Metal Rings').put(-1000 + 65-865, 430 - 1000-1830)
        bot_left_hole = metal_corners.Metal_corners('Open Corners').put(-1000 + 65 + 200-865, 430 - 1000 + 150-1830, 180)

        Layer_Difference('Open Corners', 'SiO', Single_Tile)
        Dark_Current_PCM.PCM_Dark_Current(extra_length=0, Quadrant=Quadrant, i=1, j=1, show_name= False, show_frame = False).put(3850-15,-1830)
...
nd.export_gds(filename=r'Tile PCMS V2 Semi Insulating Substrate')