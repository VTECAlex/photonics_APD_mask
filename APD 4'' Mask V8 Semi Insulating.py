...
# import Tile_PCMs
import Device_Tile_V3_Semi_Insul
import Tile_PCMs_V2_Semi_Insul_Sub
import Reticle_Main
import doted_circle
...
BVRFMF.put(0,-13117.093+1372.448+45+15)
...
for j in range(10):
    ...
    for i in range(17):
        ...
        if (x_directio_length_of_all_tiles)**2+(y_directio_length_of_all_tiles)**2< (radius_of_wafer)**2: #This is x^2+y^2<r^2 so we have devices insied the r=4''/2
            ...
            Q4 = 4
            if j!=3:
                Device_Tile_V3_Semi_Insul.APD_Tile_V2(extra_length, Q1, i, j, True, True).put(previous_position_for_Q_1_4 + extra_length/2 -15-328.147, pos1y_Q1 + j*step_y -1830 )
                Device_Tile_V3_Semi_Insul.APD_Tile_V2(extra_length, Q2, i, j, True, True).put(-previous_position_for_Q_2_3 - extra_length / 2 - 100 - 15 - 328.147, pos1y_Q1 + j * step_y - 1830)
                if j<9:
                    Device_Tile_V3_Semi_Insul.APD_Tile_V2(extra_length, Q4, i, j, True, True).put(previous_position_for_Q_1_4 + extra_length/2 -15-328.147, -pos1y_Q1 - j*step_y - 1830)
                    Device_Tile_V3_Semi_Insul.APD_Tile_V2(extra_length, Q3, i, j, True, True).put(-previous_position_for_Q_2_3  - extra_length/2 -100 -15-328.147, -pos1y_Q1 - j*step_y - 1830)
        ...
        if (x_directio_length_of_all_tiles_PCM)**2+(y_directio_length_of_all_tiles)**2< (radius_of_wafer)**2:
            ...
            Q4 = 3
            if j==3:
                Tile_PCMs_V2_Semi_Insul_Sub.Tile_PCMs_all(extra_length, Q1, i, j).put( previous_position_for_Q_1_4_PCM , pos1y_Q1 + j*step_y )
                Tile_PCMs_V2_Semi_Insul_Sub.Tile_PCMs_all(extra_length, Q2, i, j).put( previous_position_for_Q_1_4_PCM, -pos1y_Q1 - j*step_y )
                Tile_PCMs_V2_Semi_Insul_Sub.Tile_PCMs_all(extra_length, Q3, i, j).put( -previous_position_for_Q_1_4_PCM -2580+480-1000, pos1y_Q1 + j*step_y )
                Tile_PCMs_V2_Semi_Insul_Sub.Tile_PCMs_all(extra_length, Q4, i, j).put( -previous_position_for_Q_1_4_PCM -2580+480-1000,- pos1y_Q1 - j*step_y )
...
nd.export_gds(filename=r'APD 4'' Mask All layers Semi Insulating Sub_Test')
