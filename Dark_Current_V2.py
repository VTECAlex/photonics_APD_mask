...
def APD_Tile_V2(extra_length, Quadrant, i,j, show_name, show_frame):
    ...
    with nd.Cell(name = 'Device Cell V3') as Device_cell_V3:
        ...
        with nd.Cell (name = 'Right Side Devices') as Right_side_Devices:
            ...
            APD_x_position = [-26.81,-52.5,-117.2,-181.2,-245.32]#0-(50-17.5)+(50+17.532)+27,-20-(50-17.5)+(50-31.652),-70-(50-17.5)+(50-45.652),-120-(50-17.5)-10.352,-170-(50-17.5)-16.042]
            APD_distance = 750
            ...
            while k<len(APD_radii):
                ...
                with nd.Cell(name = "Devices") as Devices:
                    ...
                    P_Au_Plating = nd.strt(length=APD_Signal_length-trapezoid_height-bond_pad_size, width=P_metal_width, layer='Au plating ').put(APD_radii[k] + P_type_ring_distance-P_type_ring_width,0)#put(APD_radii[k]-P_type_ring_width- (P_type_ring_width-P_type_ring_SiO_opening_width)/2+P_type_ring_distance,0)
                ...
                k=k+1
        Right_side_Devices.put(0176.84773-50+556.29393+10.352, -270)
        ...
        if show_name == True:
            ...
            top_left_hole = metal_corners.Metal_corners_hole('Open Corners').put(-1000 + 115 + 200 - 50-200,
                                                                            4279.86 + 0.14 - 200+25, 0)

            top_right = metal_corners.Metal_corners('Metal Rings').put(1000 + 65+556.294, +4230+25, 180)
            top_right_hole = metal_corners.Metal_corners_hole('Open Corners').put(1000 + 65 - 200+556.294+25, +4230 - 150+200, -90)

            bot_right = metal_corners.Metal_corners('Metal Rings').put(-1000 + 2015+556.294+25, -1000 + 430 - 50, 90)
            bot_right_hole = metal_corners.Metal_corners_hole('Open Corners').put(-1000 + 2015 - 200 + 50+556.294+200,
                                                                             -1000 + 430 - 50 + 200-25, -180)

            bot_left = metal_corners.Metal_corners('Metal Rings').put(-1000 + 65, 430 - 1000-25)
            bot_left_hole = metal_corners.Metal_corners_hole('Open Corners').put(-1000 + 65 + 200-25, 430 - 1000 + 150-200, -270)
